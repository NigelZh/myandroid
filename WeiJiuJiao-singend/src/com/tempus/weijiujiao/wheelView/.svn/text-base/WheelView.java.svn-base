...
public class WheelView extends View {
	...
	/** Text size */
	private static  int TEXT_SIZE = 20;//sp
	...
	/** Label offset */
	private static final int LABEL_OFFSET = 8;//dp
	...
	private void initDpandSP() {
		// TODO Auto-generated method stub
		if(TEXT_SIZE==20){
			ADDITIONAL_ITEM_HEIGHT=ScreenUtils.dip2px(getContext(), ADDITIONAL_ITEM_HEIGHT);
			TEXT_SIZE=ScreenUtils.sp2px(getContext(), TEXT_SIZE);
		}
	...
	private void initResourcesIfNecessary() {
		...
		//setBackgroundResource(R.drawable.touming_bg);
		//setBackgroundDrawable(new ColorDrawable(color.touming));
	}
